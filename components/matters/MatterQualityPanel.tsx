    ...
    <div style={{ border: "1px solid rgba(0,0,0,0.07)", padding: "1.25rem" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: "0.75rem" }}>
        {[
          ...
          <div key={label} style={{ border: "1px solid rgba(0,0,0,0.05)", padding: "0.75rem" }}>
            <div style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--text-3)", letterSpacing: "0.16em", textTransform: "uppercase", marginBottom: "0.25rem" }}>
              {label}
            </div>
      ...
      <p style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--text-3)", marginTop: "0.75rem", lineHeight: 1.5 }}>
