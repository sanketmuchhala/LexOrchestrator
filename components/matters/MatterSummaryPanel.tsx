...
function Row({ label, value }: { label: string; value: string | null | undefined }) {
  ...
  return (
    <div style={{ display: "flex", gap: "1rem", borderBottom: "1px solid rgba(0,0,0,0.05)", paddingBottom: "0.5rem", marginBottom: "0.5rem" }}>
      <span style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--text-3)", letterSpacing: "0.16em", textTransform: "uppercase", minWidth: "110px", paddingTop: "0.1rem" }}>
        {label}
      </span>
      <span style={{ fontFamily: "var(--font-serif), Georgia, serif", fontSize: "14px", color: "var(--text-1)", lineHeight: 1.5 }}>
        {value}
      </span>
    </div>
  );
  ...
  return (
    <div style={{ border: "1px solid rgba(0,0,0,0.07)", padding: "1.25rem" }}>
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        <h2 style={{ fontFamily: "var(--font-serif), Georgia, serif", fontSize: "clamp(1rem, 2vw, 1.25rem)", fontWeight: 500, color: "var(--text-1)" }}>
          {matter.title}
        </h2>
      ...
      {matter.description && (
        <div style={{ marginTop: "0.75rem" }}>
          ...
          <p style={{ fontFamily: "var(--font-serif), Georgia, serif", fontSize: "14px", color: "var(--text-2)", lineHeight: 1.7 }}>
            {matter.description}
          </p>
        </div>
      )}
      <p style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--text-3)", marginTop: "0.75rem" }}>
        {matter.id}
      </p>
    </div>
  );
