      ...
      {agentGroups.map((group) => (
        ...
        >
          <div className="flex items-center gap-3 mb-2 flex-wrap">
            <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "#f4f4f4", fontWeight: 700 }}>
              {group.agentName}
            </span>
          ...
          <div className="flex flex-wrap gap-4">
            {group.totalLatencyMs > 0 && (
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "10px", color: "#737373" }}>
                <span style={{ color: "#404040" }}>latency </span>
                {(group.totalLatencyMs / 1000).toFixed(2)}s
              </span>
            )}
            {group.artifactIds.length > 0 && (
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "10px", color: "#737373" }}>
                <span style={{ color: "#404040" }}>artifacts </span>
