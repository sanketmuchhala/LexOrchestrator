  ...
  return (
    <div className="space-y-2">
      {citationReports.map((r) => (
        <div
          key={r.id}
          style={{ border: "1px solid rgba(255,255,255,0.06)", padding: "0.875rem" }}
        >
          ...
          <p style={{ fontFamily: "var(--font-serif), Georgia, serif", fontSize: "13px", color: "#f4f4f4", lineHeight: 1.5 }}>
            {r.citationText}
          </p>
          {r.normalizedCitation && r.normalizedCitation !== r.citationText && (
            <p style={{ fontFamily: "var(--font-mono)", fontSize: "10px", color: "#404040", marginTop: "0.25rem" }}>
